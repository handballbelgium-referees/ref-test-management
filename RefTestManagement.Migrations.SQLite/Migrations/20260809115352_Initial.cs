    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeqId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    StreamId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendInvitationsAutomatically = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    QuestionIds = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ...
                    SelectedAnswerIds = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    WrongQuestionIds = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    WrongAnswerIds = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    SendResultsAutomatically = table.Column<bool>(type: "INTEGER", nullable: false),
                    ResultsSentAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Language = table.Column<string>(type: "TEXT", nullable: true),
                    PrivacyNoticeVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    ...
                    AnonymizedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatorName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false, defaultValue: ""),
                    CreatorEmail = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false, defaultValue: ""),
