...
import { QuizSessionStatus } from '../../../../../../../graphql/generated';
...
export class StatusFilterTabs {
  readonly selectedStatus = input<QuizSessionStatus | undefined>();
  readonly statusCounts = input.required<IStatusCounts>();
  readonly statusChange = output<QuizSessionStatus | undefined>();
  ...
  protected onStatusChange(status?: QuizSessionStatus, buttonElement?: EventTarget | null): void {
