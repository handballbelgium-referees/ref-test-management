...
| **Hot Chocolate** | 16.6.2 | GraphQL server with authorization, data loaders, and filtering |
...
| Technology | Version | Purpose |
| --- | --- | --- |
| **Angular** | 22.1.5 | SPA framework with standalone components and signals |
...
| **GraphQL Code Generator** | 7.3.1 | Generates TypeScript types from the GraphQL schema |
