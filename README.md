...
| **Hot Chocolate** | 16.5.1 | GraphQL server with authorization, data loaders, and filtering |
...
| Technology | Version | Purpose |
| --- | --- | --- |
| **Angular** | 22.1.0 | SPA framework with standalone components and signals |
| **TypeScript** | 6.0.3 | Strict type-checking |
| **Apollo Client** | 4.2.9 | GraphQL client with normalized caching |
